        ...
        if provider == "openrouter":
            return self._call_openai_compat("https://openrouter.ai/api/v1/chat/completions",
                                            ...
                                            extra_headers={"HTTP-Referer": "http://localhost",
                                                           "X-Title": "ILMA"}, **kwargs)
        elif provider == "wrapper-nvidia":
            # Phase 72-fix: local wrapper-nvidia (127.0.0.1:9100) — key-pooled, force-free.
            # Preferred over remote nvidia (integrate.api.nvidia.com) for all nvidia/* models.
            return self._call_openai_compat("http://127.0.0.1:9100/v1/chat/completions",
                                            api_key or "wrapper-local-key", model_id, messages, **kwargs)
        elif provider == "nvidia":
            # Remote NVIDIA NIM — fallback if wrapper-nvidia unreachable.
