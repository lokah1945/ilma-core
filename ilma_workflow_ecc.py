...
def run_workflow(task: str) -> dict:
    ...
    try:
        ...
        # FIX 2026-07-09 (audit F2): ilma_learning_memory module does NOT exist.
        # Replaced with ilma_learning_engine.ILMALearningEngine (verified present, has learn_from_task).
        from ilma_learning_engine import get_learning_engine
        memory = get_learning_engine()
        ...
        # Record to learning engine (builds performance DB via learn_from_task)
        memory.learn_from_task({
            "task_type": task_type,
            "model_id": model_used,
            "provider": "hermes",
            "quality": quality,
