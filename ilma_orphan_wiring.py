...
_ORPHAN_SPECS: List[Dict[str, Optional[str]]] = [
    ...
    # LAYER_6 — knowledge
    {"module": "ilma_skill_indexer",            "layer": "LAYER_6",  "purpose": "Index all installed skills (frontmatter scan)",   "callable": "index_skills",  "cli": "skill-index"},
    ...
    {"module": "ilma_production_monitor",       "layer": "LAYER_8",  "purpose": "Production-readiness monitor",                  "callable": "generate_summary", "cli": "prod-monitor"},
    ...
    # LAYER_3 — workflow engines (library modules, no CLI)
    {"module": "ilma_dag_pipeline",            "layer": "LAYER_3",  "purpose": "DAG pipeline engine (parallel task execution)",   "callable": "DAGPipelineEngine", "cli": None},
    {"module": "ilma_fallback_cascade",        "layer": "LAYER_3",  "purpose": "Multi-tier fallback cascade engine",             "callable": "FallbackCascadeEngine", "cli": None},
    {"module": "ilma_quality_gate",            "layer": "LAYER_4",  "purpose": "L1-L10 quality gate (superset of judge_system)", "callable": "ILMAQualityGate", "cli": None},
]
...
class OrphanWiring:
    ...
    def _register_specs(self) -> None:
        for spec in _ORPHAN_SPECS:
            # Use module_name as key when cli is None (library modules)
            key = spec["cli"] or spec["module"]
            self.capabilities[key] = OrphanCapability(
    ...
    def list_capabilities(self) -> List[Dict[str, Any]]:
        ...
        out = []
        for cli, cap in sorted(self.capabilities.items(), key=lambda x: (x[0] or "")):
            out.append({
                "cli": cli,
                "module": cap.module_name,
                "layer": cap.layer,
