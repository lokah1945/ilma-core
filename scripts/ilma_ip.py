...
Generated: 2026-05-06T23:06:54.864882
=========================================
...
EXAMPLES:
    python3 ilma_ip.py --verbose
    python3 ilma_ip.py --dry-run
...
def main() -> int:
    try:
        ...
        handler = IpHandler(verbose=args.verbose, dry_run=args.dry_run)
