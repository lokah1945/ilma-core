...
Generated: 2026-05-06T23:06:54.888263
=========================================
...
USAGE:
    python3 ilma_skill_creator.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_skill_creator.py --verbose
    python3 ilma_skill_creator.py --dry-run
...
class SkillCreatorHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = SkillCreatorHandler(verbose=args.verbose, dry_run=args.dry_run)
