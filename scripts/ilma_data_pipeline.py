...
Generated: 2026-05-06T23:06:54.847195
=========================================
...
USAGE:
    python3 ilma_data_pipeline.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_data_pipeline.py --verbose
    python3 ilma_data_pipeline.py --dry-run
...
def main() -> int:
    try:
        ...
        handler = DataPipelineHandler(verbose=args.verbose, dry_run=args.dry_run)
