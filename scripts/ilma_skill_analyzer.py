...
Generated: 2026-05-06T23:06:54.887700
=========================================
...
USAGE:
    python3 ilma_skill_analyzer.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_skill_analyzer.py --verbose
    python3 ilma_skill_analyzer.py --dry-run
...
class SkillAnalyzerHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = SkillAnalyzerHandler(verbose=args.verbose, dry_run=args.dry_run)
