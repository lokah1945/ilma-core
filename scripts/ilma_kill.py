...
Generated: 2026-05-06T23:06:54.865344
=========================================
...
EXAMPLES:
    python3 ilma_kill.py --verbose
    python3 ilma_kill.py --dry-run
...
def main() -> int:
    try:
        ...
        handler = KillHandler(verbose=args.verbose, dry_run=args.dry_run)
