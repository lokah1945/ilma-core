...
Generated: 2026-05-06T23:06:54.888764
=========================================
...
USAGE:
    python3 ilma_skill_health.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_skill_health.py --verbose
    python3 ilma_skill_health.py --dry-run
...
class SkillHealthHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = SkillHealthHandler(verbose=args.verbose, dry_run=args.dry_run)
