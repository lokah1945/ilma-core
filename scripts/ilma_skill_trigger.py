...
Generated: 2026-05-06T23:06:54.889271
=========================================
...
USAGE:
    python3 ilma_skill_trigger.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_skill_trigger.py --verbose
    python3 ilma_skill_trigger.py --dry-run
...
class SkillTriggerHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = SkillTriggerHandler(verbose=args.verbose, dry_run=args.dry_run)
