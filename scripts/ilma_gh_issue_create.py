...
Generated: 2026-05-06T23:06:54.860911
=========================================
...
USAGE:
    python3 ilma_gh_issue_create.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_gh_issue_create.py --verbose
    python3 ilma_gh_issue_create.py --dry-run
...
class GhIssueCreateHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = GhIssueCreateHandler(verbose=args.verbose, dry_run=args.dry_run)
