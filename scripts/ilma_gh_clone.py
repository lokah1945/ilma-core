...
Generated: 2026-05-06T23:06:54.859014
=========================================
...
USAGE:
    python3 ilma_gh_clone.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_gh_clone.py --verbose
    python3 ilma_gh_clone.py --dry-run
...
class GhCloneHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = GhCloneHandler(verbose=args.verbose, dry_run=args.dry_run)
