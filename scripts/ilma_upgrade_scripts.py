...
Generated: 2026-05-06T23:06:54.902551
=========================================
...
USAGE:
    python3 ilma_upgrade_scripts.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_upgrade_scripts.py --verbose
    python3 ilma_upgrade_scripts.py --dry-run
...
class UpgradeScriptsHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = UpgradeScriptsHandler(verbose=args.verbose, dry_run=args.dry_run)
