...
Generated: 2026-05-06T23:06:54.819749
=========================================
...
USAGE:
    python3 ilma_add_critical_scripts.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_add_critical_scripts.py --verbose
    python3 ilma_add_critical_scripts.py --dry-run
...
class AddCriticalScriptsHandler(BaseHandler):
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog='ilma_add_critical_scripts.py',
...
def main() -> int:
    try:
        ...
        handler = AddCriticalScriptsHandler(verbose=args.verbose, dry_run=args.dry_run)
