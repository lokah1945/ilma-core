...
Generated: 2026-05-06T23:06:54.859926
=========================================
...
USAGE:
    python3 ilma_gh_fork.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_gh_fork.py --verbose
    python3 ilma_gh_fork.py --dry-run
...
class GhForkHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = GhForkHandler(verbose=args.verbose, dry_run=args.dry_run)
