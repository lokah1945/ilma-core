...
Generated: 2026-05-06T23:06:54.848555
=========================================
...
USAGE:
    python3 ilma_delete.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_delete.py --verbose
    python3 ilma_delete.py --dry-run
...
def main() -> int:
    try:
        ...
        handler = DeleteHandler(verbose=args.verbose, dry_run=args.dry_run)
