...
Generated: 2026-05-06T23:06:54.860390
=========================================
...
USAGE:
    python3 ilma_gh_issue.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_gh_issue.py --verbose
    python3 ilma_gh_issue.py --dry-run
...
class GhIssueHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = GhIssueHandler(verbose=args.verbose, dry_run=args.dry_run)
