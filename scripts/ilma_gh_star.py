...
Generated: 2026-05-06T23:06:54.861887
=========================================
...
USAGE:
    python3 ilma_gh_star.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_gh_star.py --verbose
    python3 ilma_gh_star.py --dry-run
...
class GhStarHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = GhStarHandler(verbose=args.verbose, dry_run=args.dry_run)
