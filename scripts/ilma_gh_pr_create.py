...
Generated: 2026-05-06T23:06:54.861386
=========================================
...
USAGE:
    python3 ilma_gh_pr_create.py [OPTIONS]
...
EXAMPLES:
    python3 ilma_gh_pr_create.py --verbose
    python3 ilma_gh_pr_create.py --dry-run
...
class GhPrCreateHandler(BaseHandler):
...
def main() -> int:
    try:
        ...
        handler = GhPrCreateHandler(verbose=args.verbose, dry_run=args.dry_run)
