...
class _AsyncHTTPClient:
    ...
    async def post(self, url: str, headers: dict, json_body: dict, timeout: int = 300) -> dict:
...
async def generate(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        if fb is None and not model_override:
            raise ValueError("fb must be set before HTTP call")
