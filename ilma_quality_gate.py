...
class ILMAQualityGate:
    ...
    def _l5_performance(self, content: str, task: str, path: str, ctype: str) -> LevelResult:
        ...
        if ctype == "python":
            try:
                ...
                # FIX 2026-07-09 (deep audit F11): do not silently swallow nesting-depth parse errors.
                logger.debug(f"[QualityGate] nesting check skipped: {_e}")
    ...
    def _check_nesting_depth(self, tree) -> int:
        ...
        try:
            ...
            # FIX 2026-07-09 (deep audit F11): log instead of swallow
            logger.debug(f"[QualityGate] depth walk skipped: {_e}")
        return max_depth
