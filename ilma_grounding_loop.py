...
def _embed(text: str) -> Optional[list]:
    ...
    try:
        ...
        # FIX 2026-07-09 (deep audit F12): log the backend failure instead of silently
        # disabling embeddings globally. Per-claim retry is avoided, but the cause is visible.
        import logging
        logging.getLogger("ILMA.Grounding").warning(f"[Grounding] embedding backend unavailable, fallback lexical: {_e}")
