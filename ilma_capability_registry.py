...
# Canonical capability evidence ledger (audit/confidence tracking, 108 entries).
# NOTE: the in-process runtime registry (ilma_capability_registry.CapabilityRegistry)
# seeds 37 hard-coded runtime capabilities; this JSON is the broader evidence ledger.
ILMA_CAPABILITY_REGISTRY_JSON = ILMA_PROFILES_DIR / "ilma" / "config" / "ilma_capability_registry.json"
