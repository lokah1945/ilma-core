...
if os.environ.get("ILMA_ADMIN_OVERRIDE") != "1":
    raise PermissionError("ILMA_SECURITY_POLICY: godmode red-teaming execution is explicitly FORBIDDEN without ILMA_ADMIN_OVERRIDE=1.")
